...
/*
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    nf-core/variant-annotation
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    Github : https://github.com/nf-core/variant-annotation
    Website: https://nf-co.re/variant-annotation
    Slack  : https://nfcore.slack.com/channels/variant-annotation
----------------------------------------------------------------------------------------
*/
...
include { VARIANT_ANNOTATION } from './workflows/variant-annotation'

//
// WORKFLOW: Run main nf-core/variant-annotation analysis pipeline
//
workflow NFCORE_VARIANT_ANNOTATION {
    VARIANT_ANNOTATION ()
}
